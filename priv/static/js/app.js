  ...
  return function (e) {
    ...
    var b = function (e) {
      return function (t, n, i) {
        ...
        function L(e, t, n) {
          !1 !== w(e) && (t && t.removeChild(e), A(e), function e(t, n) {
            if (t.nodeType === f) for (var i = t.firstChild; i;) {
              var r = void 0;
              n && (r = u(i)) ? P(r) : (A(i), i.firstChild && e(i, n)), i = i.nextSibling;
            }
          }(e, n));
        }
        ...
        var _ = t,
            D = _.nodeType,
            R = n.nodeType;
        if (!S) if (D === f) R === f ? l(t, n) || (A(t), _ = function (e, t) {
    ...
    te.LiveImgPreview = {
      mounted: function () {
        var e = this;
        this.ref = this.el.getAttribute("data-phx-entry-ref"), this.inputEl = document.getElementById(this.el.getAttribute("data-phx-upload-ref")), ie.getEntryDataURL(this.inputEl, this.ref, function (t) {
          return e.el.src = t;
        });
      }
    };
    ...
    var ne = 0,
          ...
          if (delete e.c, this.rendered = this.recursiveMerge(this.rendered, e), this.rendered.c = this.rendered.c || {}, t) {
            ...
            for (var i in t) {
              ...
              if ("number" == typeof a) {
                ...
                o = X(o), this.doRecursiveMerge(o, r), o.s = a;
        ...
        value: function (e, t, n) {
          ...
          var a = o.content,
            ...
            var a = x(e, 2),
                s = a[0],
                c = a[1];
            return n.nodeType === Node.ELEMENT_NODE ? n.getAttribute(j) ? [s, !0] : (n.setAttribute(j, t), n.id || (n.id = "".concat(i.parentViewId(), "-").concat(t, "-").concat(r)), u && (n.setAttribute("data-phx-skip", ""), n.innerHTML = ""), [!0, c]) : "" !== n.nodeValue.trim() ? (z("only HTML element tags are allowed at the root of components.\n\n" + 'got: "'.concat(n.nodeValue.trim(), '"\n\n') + "within:\n", o.innerHTML.trim()), n.replaceWith(i.createSpan(n.nodeValue, t)), [!0, c]) : (n.remove(), [s, c]);
          }, [!1, !1]), 2),
              c = s[0],
              l = s[1];
      ...
      return D(e, [{
        ...
        value: function (e) {
          ...
          return t.pathname + t.search !== e.pathname + e.search && (this.currentLocation = X(e), !0);
        }
      }, {
        key: "bindForms",
        value: function () {
      ...
      syncPendingRef: function (e, t, n) {
        ...
        return null === i || (le.isFormInput(e) || null !== e.getAttribute(n) ? ("file" === e.type && le.mergeAttrs(e, t, {
          isIgnored: !0
        }), le.putPrivate(e, F, t), !1) : (H.forEach(function (n) {
      ...
      function e(t, n, i) {
        ...
        }), this.containerId = n.id, this.updateType = i, this.elementsToModify = a, this.elementIdsToAdd = E(o).filter(function (e) {
          return !r.has(e);
        });
      }
            ...
            return this.trackBefore("added", i), this.trackBefore("updated", i, i), n.time("morphdom", function () {
              b(o, y, {
                ...
                onBeforeNodeDiscarded: function (t) {
                  return !(!t.getAttribute || null === t.getAttribute("data-phx-remove")) || (null === t.parentNode || !le.isPhxUpdate(t.parentNode, l, ["append", "prepend"]) || !t.id) && !e.skipCIDSibling(t) && (e.trackBefore("discarded", t), !0);
                },
                ...
                onBeforeElUpdated: function (t, n) {
                  ...
                  if (!le.syncPendingRef(t, n, h)) return "file" === t.type && (e.trackBefore("updated", t, n), p.push(t)), !1;

                  if (le.isPhxChild(n)) {
                    var i = t.getAttribute(J);
                    return le.mergeAttrs(t, n), t.setAttribute(J, i), t.setAttribute("data-phx-root-id", e.rootID), !1;
                  }
      ...
      return D(e, [{
        ...
        value: function (e, t, n) {
          ...
          0 === le.findPhxChildrenInFragment(t, this.id).filter(function (e) {
            ...
            return n && e.setAttribute(J, n), i.joinChild(e);
        ...
        key: "destroyHook",
        value: function (e) {
          e.__trigger__("destroyed"), e.__cleanup__(), delete this.viewHooks[pe.elementID(e.el)];
        }
      }, {
        ...
        value: function (e) {
          ...
          le.all(this.el, "[".concat(F, '="').concat(e, '"]'), function (e) {
            ...
            if (i) {
              ...
              he.patchEl(e, i, t.liveSocket.getActiveElement()), r && t.triggerUpdatedHook(r), le.deletePrivate(e, F);
            }
          });
        }
      }, {
        ...
        value: function (e) {
          ...
          i.length > 0 && ((t = this.pruningCIDs).push.apply(t, E(i)), this.pushWithReply(null, "cids_will_destroy", {
            cids: i
          }, function () {
...
var Hooks = {};
Hooks.ScrollableObserver = {
  mounted: function mounted() {
    var _this = this;

    var sortable = new Draggable.Sortable(document.querySelectorAll('ul'), {
      draggable: 'li'
    });
    sortable.on('sortable:sorted', function (e) {
      _this.pushEvent("sorted", {
